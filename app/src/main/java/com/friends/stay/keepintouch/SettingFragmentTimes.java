...
//        textViewNextDate = (TextView) findViewById(R.id.textViewNextDate);
        ...
        textViewSun.setText(convertWeekDays(NextPreWeekday[0])
                + "\nSun");
        textViewMon.setText(convertWeekDays(NextPreWeekday[1])
                + "\nMon");
        textViewTue.setText(convertWeekDays(NextPreWeekday[2])
                + "\nTue");
        textViewWed.setText(convertWeekDays(NextPreWeekday[3])
                + "\nWeb");
        textViewThu.setText(convertWeekDays(NextPreWeekday[4])
                + "\nThu");
        textViewFri.setText(convertWeekDays(NextPreWeekday[5])
                + "\nFri");
        textViewSat.setText(convertWeekDays(NextPreWeekday[6])
                + "\nSat");
        try
        {
    ...
    private class LoadViewsInToWeekView extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                ...
                dialog = ProgressDialog.show(SettingFragmentTimes.this, null, null,
                        true, false);
